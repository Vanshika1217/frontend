...
const DriverProfile = () => {
  ...
  const fetchDriverProfile = async () => {
    ...
    try {
      const response = await axios.get('https://backend-delivery-eqjf.onrender.com/api/partners/me', {
        headers: {
  ...
  const handleSaveClick = async () => {
    ...
    try {
      await axios.put("https://backend-delivery-eqjf.onrender.com/api/driver/me", updatedData, {
